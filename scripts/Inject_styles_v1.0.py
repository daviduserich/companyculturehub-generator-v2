...
def inject_styles(project_name):
    ...
    for variant in preferred_variants:
        ...
        for component, style in styles.items():
            ...
            output["page_content"][component].extend([
                {"name": "styling_default", "value": style["class"]},
                {"name": "background_color", "value": style["background_color"]},
                {"name": "card_style", "value": style["card_style"]},
                {"name": "image_frame", "value": style["image_frame"]},
                {"name": "button_style", "value": style["button_style"]}
            ])
