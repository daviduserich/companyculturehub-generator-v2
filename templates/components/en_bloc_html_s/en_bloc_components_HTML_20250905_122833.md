# HTML-Komponenten-Zusammenzug (en bloc)
...
## HTML-Modul: `benefits_section.html`
...
## HTML-Modul: `career_cta_section.html`
...
## HTML-Modul: `culture_section.html`
...
## HTML-Modul: `diversity_section.html`
...
## HTML-Modul: `footer_section.html`
...
## HTML-Modul: `location_section.html`
...
## HTML-Modul: `logo_header_section.html`
...
## HTML-Modul: `navigation_section.html`
...
<style>
    ...
    /* Varianten für Hintergrund */
    .bg-solid .navigation {
        background: var(--color-primary); /* Einfarbiger Hintergrund */
    }
    .bg-gradient .navigation {
        background: var(--nav-gradient); /* Verlaufshintergrund */
    }

    /* Button-Stile für Links */
    .button-solid .nav-list a {
        background: var(--color-primary);
        border: 1px solid var(--color-accent);
        border-radius: 4px;
        color: var(--text-on-primary);
    }
    .button-gradient .nav-list a {
        background: var(--nav-gradient);
        border: none;
        border-radius: 4px;
        color: var(--text-on-secondary);
    }
    .button-solid .nav-list a:hover,
    .button-gradient .nav-list a:hover {
        opacity: 0.9;
...
## HTML-Modul: `story_telling_section.html`
...
## HTML-Modul: `technik_header_section.html`
...
## HTML-Modul: `values_section.html`
